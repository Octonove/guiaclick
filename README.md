...
[![license](https://img.shields.io/github/license/Octonove/guiaclick)](LICENSE)
[![release](https://img.shields.io/github/v/release/Octonove/guiaclick)](https://github.com/Octonove/guiaclick/releases/latest)
[![platform](https://img.shields.io/badge/platform-Windows%2010%2F11-1E3A5F)](https://github.com/Octonove/guiaclick/releases/latest)

Record your clicks, get a step-by-step guide — annotated screenshots, blur, PDF/HTML export. Like Scribe, but local.

**Free · Open source (MIT) · 100% local — nothing ever leaves your PC · No accounts, no limits, no watermarks**

<img src="docs/screenshot.png" width="720" alt="GuiaClick screenshot">

> 🇪🇸 ¿Prefieres leerlo en español? → **[README en español](README.es.md)**

<!-- invokard-coffee -->
**&#9749; If this saves you time, buy me a coffee.** [![Buy me a coffee with PayPal](https://img.shields.io/badge/PayPal-Buy%20me%20a%20coffee-00457C?logo=paypal&logoColor=white)](https://www.paypal.com/donate/?business=stradoxx%40gmail.com&no_recurring=0&currency_code=EUR&item_name=Support%20guiaclick)
...
- Auto-captures a numbered screenshot for **every click**
- Edit titles and notes; optional **local AI** polish for your texts
- Blur sensitive data before sharing
- Export to **PDF, HTML or Markdown**; save guides as projects

## Download (Windows 10/11)

### ➡️ [**Download GuiaClick (installer .exe)**](https://github.com/Octonove/guiaclick/releases/latest/download/GuiaClick-Setup.exe)
...
> ⭐ **If GuiaClick is useful to you, a star on GitHub is the best way to support it — it costs nothing and helps a lot.**
